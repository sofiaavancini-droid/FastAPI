...
from app.schemas import ProductoCreate, CategoriaCreate, UsuarioCreate
...
def crear_usuario(db: Session, usuario: UsuarioCreate):
    # Verificamos si ya existe el usuario por email o nombre
    ...
    db_usuario = Usuario(
        ...
        email=usuario.email,
        hashed_password=hash_password(usuario.password),  # Asegurate que en models.py se llame hashed_password
